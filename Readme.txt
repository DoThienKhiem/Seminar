...
II.	Các chức năng.
      ...
      4.	Thanh toán
         ...
         4.4.	In hóa đơn
      5.	Quản lý
         5.1.	Quản lý cửa hàng
         5.2.	Quản lý hóa đơn
         5.3.	Quản lý nhân viên
         5.4.	Quản lý nhà cung cấp
         5.5.	Quản lý nhà vận chuyển
         5.6.	Thống kê doanh thu
      6.	Khác
         6.1.	Trò chuyện với người quản lý
         6.2.	Like shop thông qua facebook
         6.3.	Đinh vị shop trên google maps.
         6.4.	Google analytics 
         6.5.	SMTP *
         6.6.	Giao diện người dùng song ngữ *
         6.7.	Chia sẻ thông tin sản phảm cho bạn bè
...
III.	Các module đã cài đặt:
     ...
     38.	Moneybookers v1.6.8 - by -  Official
              Accepts payments by Moneybookers.	  
     ...
     76.	Cross-selling v0.9.2 - by PrestaShop
     77.	NVD3 Charts v1.3 - by PrestaShop
